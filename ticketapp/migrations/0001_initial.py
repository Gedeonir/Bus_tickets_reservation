# Generated by Django 4.0 on 2022-01-17 12:35
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            name='payements',
            fields=[
                ('payement_id', models.AutoField(primary_key=True, serialize=False)),
        ...
        migrations.AddField(
            model_name='bookings',
            name='customer',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='ticketapp.customers'),
        ),
        migrations.AddField(
            model_name='bookings',
            name='schedule',
